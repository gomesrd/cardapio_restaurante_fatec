    ...
    List<CategoryMenu> list = [
      CategoryMenu('Burgers', [
        ...
        ItemMenu('Veggie Burger', 'Hamburguer vegetariano com abacate e queijo',
            'https://cdn.pixabay.com/photo/2016/12/06/18/27/vegetarian-1880547_960_720.jpg', 16.50),
      ...
      CategoryMenu('Pizzas', [
        ...
        ItemMenu('Pizza Pepperoni', 'Molho de tomate, mozzarella e pepperoni picante',
            'https://cdn.pixabay.com/photo/2015/06/19/15/15/pizza-815435_960_720.jpg', 35.00),
        ItemMenu('Pizza Quatro Queijos', 'Mistura de quatro queijos deliciosos',
            'https://cdn.pixabay.com/photo/2020/05/21/07/33/pizza-5192813_960_720.jpg', 33.00),
        ItemMenu('Pizza Portuguesa', 'Presunto, ovos, cebola e azeitonas',
            'https://cdn.pixabay.com/photo/2016/11/18/16/20/pizza-1837340_960_720.jpg', 32.00),
        ItemMenu('Pizza Frango com Catupiry', 'Frango desfiado com catupiry e molho de tomate',
            'https://cdn.pixabay.com/photo/2020/05/21/07/33/pizza-5192813_960_720.jpg', 36.00),
      ]),
      CategoryMenu('Massas', [
      ...
      CategoryMenu('Saladas', [
        ItemMenu('Salada Caesar', 'Alface romana, croutons, queijo parmesão e molho caesar',
            'https://cdn.pixabay.com/photo/2016/07/29/12/11/caesar-1559046_960_720.jpg', 20.00),
        ...
        ItemMenu('Salada Caprese', 'Tomate, mozzarella e manjericão fresco',
            'https://cdn.pixabay.com/photo/2017/06/02/18/24/tomatoes-2367027_960_720.jpg', 18.00),
        ItemMenu('Salada de Frango', 'Frango grelhado, alface, tomate e molho de mostarda',
            'https://cdn.pixabay.com/photo/2014/06/18/15/24/food-371406_960_720.jpg', 25.00),
      ...
      CategoryMenu('Bebidas', [
        ItemMenu('Coca-Cola', 'Refrigerante Coca-Cola 350ml',
            'https://cdn.pixabay.com/photo/2016/11/21/17/45/coca-cola-1842402_960_720.jpg', 5.00),
        ...
        ItemMenu('Cerveja', 'Cerveja Pilsen 600ml',
            'https://cdn.pixabay.com/photo/2015/09/02/12/33/beer-918591_960_720.jpg', 12.00),
        ItemMenu('Água Mineral', 'Água mineral sem gás 500ml',
            'https://cdn.pixabay.com/photo/2017/05/11/07/31/bottle-2305578_960_720.jpg', 3.00),
        ItemMenu('Vinho Tinto', 'Vinho tinto seco 750ml',
            'https://cdn.pixabay.com/photo/2016/11/29/09/15/food-1868724_960_720.jpg', 50.00),
      ]),
    ];
